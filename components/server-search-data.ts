...
export const serverSearchData: SearchResult[] = [
  ...
  },
  {
    ...
    url: "/developer-docs/getting-started-with-sdk#1-launching-the-tools-interface",
    type: "heading",
    parentPage: "Getting Started with Code on Model HQ",
  },
  {
    title: "Launching the Backend Server",
    url: "/developer-docs/getting-started-with-sdk#2-launching-the-backend-server",
    type: "heading",
    parentPage: "Getting Started with Code on Model HQ",
  },
  {
    title: "Launch Backend Inference Server Guide",
    url: "/developer-docs/getting-started-with-sdk#launch-backend-inference-server-guide",
    type: "heading",
    parentPage: "Getting Started with Code on Model HQ",
  },
  {
    title: "Configure Backend API Server for Headless Mode",
    url: "/developer-docs/getting-started-with-sdk#configure-or-configure-backend-api-sever-for-headless-mode",
    type: "heading",
    parentPage: "Getting Started with Code on Model HQ",
  },
  {
    title: "Downloading the Model HQ SDK",
    url: "/developer-docs/getting-started-with-sdk#downloading-the-model-hq-sdk",
    type: "heading",
    parentPage: "Getting Started with Code on Model HQ",
  },
  {
    title: "Making the SDK Importable",
    url: "/developer-docs/getting-started-with-sdk#making-the-sdk-importable",
    type: "heading",
    parentPage: "Getting Started with Code on Model HQ",
  },
  {
    title: "Closing Backend Server",
    url: "/developer-docs/getting-started-with-sdk#closing-backend-server",
    type: "heading",
    parentPage: "Getting Started with Code on Model HQ",
  },
  ...
  {
    title: "Requirements",
    url: "/developer-docs/server-deployment#requirements",
    type: "heading",
    parentPage: "Server Deployment",
  },
  {
    title: "Starting the Server",
    url: "/developer-docs/server-deployment#starting-the-server",
    type: "heading",
    parentPage: "Server Deployment",
  },
  {
    title: "Connecting to the Server",
    url: "/developer-docs/server-deployment#connecting-to-the-server",
    type: "heading",
    parentPage: "Server Deployment",
  },
  {
    title: "Remote Access via SSH Tunnel",
    url: "/developer-docs/server-deployment#remote-access-via-ssh-tunnel",
    type: "heading",
    parentPage: "Server Deployment",
  },
  {
    title: "Verifying the Connection",
    url: "/developer-docs/server-deployment#verifying-the-connection",
    type: "heading",
    parentPage: "Server Deployment",
  },
  {
    title: "Multi-user Considerations",
    url: "/developer-docs/server-deployment#multi-user-considerations",
    type: "heading",
    parentPage: "Server Deployment",
  },
  ...
  },
  {
    ...
    url: "/developer-docs/hello-world/hello-world#complete-example",
    type: "heading",
    parentPage: "Hello World — Model HQ Client SDK",
  },
  {
    title: "What the Output Looks Like",
    url: "/developer-docs/hello-world/hello-world#what-the-output-looks-like",
    type: "heading",
    parentPage: "Hello World — Model HQ Client SDK",
  },
  {
    title: "Trying a Different Model",
    url: "/developer-docs/hello-world/hello-world#trying-a-different-model",
    type: "heading",
    parentPage: "Hello World — Model HQ Client SDK",
  },
  ...
  // ==================== CHAT ====================
  {
    ...
    url: "/developer-docs/hello-world/chat",
    type: "page",
    description: "Interact with Model HQ apps through sessions, send messages and receive streamed responses",
  },
  {
    title: "Starting a Session",
    url: "/developer-docs/hello-world/chat#starting-a-session",
    type: "heading",
    parentPage: "Chat — Model HQ Client SDK",
  },
  {
    title: "Sending Messages",
    url: "/developer-docs/hello-world/chat#sending-messages",
    type: "heading",
    parentPage: "Chat — Model HQ Client SDK",
  },
  {
    title: "Running an Agent Inside a Session",
    url: "/developer-docs/hello-world/chat#running-an-agent-inside-a-session",
    type: "heading",
    parentPage: "Chat — Model HQ Client SDK",
  },
  {
    title: "Managing Sessions",
    url: "/developer-docs/hello-world/chat#managing-sessions",
    type: "heading",
    parentPage: "Chat — Model HQ Client SDK",
  },
  {
    title: "Listing and Discovering Apps",
    url: "/developer-docs/hello-world/chat#listing-and-discovering-apps",
    type: "heading",
    parentPage: "Chat — Model HQ Client SDK",
  },
  ...
  // ==================== AGENTS ====================
  {
    ...
    url: "/developer-docs/hello-world/agents",
    type: "page",
    description: "Discover, inspect and run pre-built multi-step agent processes via the SDK",
  },
  {
    title: "Discovering Agents",
    url: "/developer-docs/hello-world/agents#discovering-agents",
    type: "heading",
    parentPage: "Agents — Model HQ Client SDK",
  },
  {
    title: "Running Agents",
    url: "/developer-docs/hello-world/agents#running-agents",
    type: "heading",
    parentPage: "Agents — Model HQ Client SDK",
  },
  {
    title: "Retrieving Agent Output",
    url: "/developer-docs/hello-world/agents#retrieving-agent-output",
    type: "heading",
    parentPage: "Agents — Model HQ Client SDK",
  },
  {
    title: "Managing Agents",
    url: "/developer-docs/hello-world/agents#managing-agents",
    type: "heading",
    parentPage: "Agents — Model HQ Client SDK",
  },
  {
    title: "Schedule an Agent",
    url: "/developer-docs/hello-world/agents#schedule-an-agent",
    type: "heading",
    parentPage: "Agents — Model HQ Client SDK",
  },
  {
    title: "Services and Integrations",
    url: "/developer-docs/hello-world/agents#services-and-integrations",
    type: "heading",
    parentPage: "Agents — Model HQ Client SDK",
  },
  ...
  // ==================== RAG ====================
  {
    ...
    url: "/developer-docs/hello-world/rag",
    type: "page",
  ...
  },
  {
    ...
    url: "/developer-docs/hello-world/rag#three-rag-approaches",
    type: "heading",
    parentPage: "RAG — Model HQ Client SDK",
  },
  {
    title: "Document Inference",
    url: "/developer-docs/hello-world/rag#1-document-inference",
    type: "heading",
    parentPage: "RAG — Model HQ Client SDK",
  },
  {
    title: "Source Inference",
    url: "/developer-docs/hello-world/rag#2-source-inference",
    type: "heading",
    parentPage: "RAG — Model HQ Client SDK",
  },
  {
    title: "Library Inference",
    url: "/developer-docs/hello-world/rag#3-library-inference",
    type: "heading",
    parentPage: "RAG — Model HQ Client SDK",
  },
  {
    title: "Create a Library",
    url: "/developer-docs/hello-world/rag#create-a-library",
    type: "heading",
    parentPage: "RAG — Model HQ Client SDK",
  },
  {
    title: "Install Embeddings",
    url: "/developer-docs/hello-world/rag#install-embeddings",
    type: "heading",
    parentPage: "RAG — Model HQ Client SDK",
  },
  {
    title: "Query the Library",
    url: "/developer-docs/hello-world/rag#query-the-library",
    type: "heading",
    parentPage: "RAG — Model HQ Client SDK",
  },
  {
    title: "Manage a Library",
    url: "/developer-docs/hello-world/rag#manage-a-library",
    type: "heading",
    parentPage: "RAG — Model HQ Client SDK",
  },
  ...
  // ==================== VISION & MEDIA ====================
  {
    ...
    url: "/developer-docs/hello-world/vision",
    type: "page",
    description: "Image analysis, image generation, text-to-speech, and web search via the SDK",
  },
  {
    title: "Image Analysis",
    url: "/developer-docs/hello-world/vision#image-analysis",
    type: "heading",
    parentPage: "Vision & Media — Model HQ Client SDK",
  },
  {
    title: "Image Generation",
    url: "/developer-docs/hello-world/vision#image-generation",
    type: "heading",
    parentPage: "Vision & Media — Model HQ Client SDK",
  },
  {
    title: "Text-to-Speech",
    url: "/developer-docs/hello-world/vision#text-to-speech",
    type: "heading",
    parentPage: "Vision & Media — Model HQ Client SDK",
  },
  {
    title: "Web Search",
    url: "/developer-docs/hello-world/vision#web-search",
    type: "heading",
    parentPage: "Vision & Media — Model HQ Client SDK",
  },
  ...
  // ==================== SDK REFERENCE ====================
  {
    ...
    url: "/developer-docs/hello-world/sdk-reference",
    type: "page",
    description: "Quick-reference for all commonly used SDK methods grouped by category",
  },
  {
    title: "Client Setup",
    url: "/developer-docs/hello-world/sdk-reference#client-setup",
    type: "heading",
    parentPage: "SDK Reference — Model HQ Client SDK",
  },
  {
    title: "Inference Methods",
    url: "/developer-docs/hello-world/sdk-reference#inference",
    type: "heading",
    parentPage: "SDK Reference — Model HQ Client SDK",
  },
  {
    title: "Vision & Media Methods",
    url: "/developer-docs/hello-world/sdk-reference#vision-media",
    type: "heading",
    parentPage: "SDK Reference — Model HQ Client SDK",
  },
  {
    title: "Model Management Methods",
    url: "/developer-docs/hello-world/sdk-reference#model-management",
    type: "heading",
    parentPage: "SDK Reference — Model HQ Client SDK",
  },
  {
    title: "RAG Methods",
    url: "/developer-docs/hello-world/sdk-reference#rag-document-inference",
    type: "heading",
    parentPage: "SDK Reference — Model HQ Client SDK",
  },
  {
    title: "Agent Methods",
    url: "/developer-docs/hello-world/sdk-reference#agents",
    type: "heading",
    parentPage: "SDK Reference — Model HQ Client SDK",
  },
