...
// Reclassified model catalog (see APPLE_MODELS.md)
const MODEL_GROUPS: ModelGroup[] = [
  {
    group: "All Supported Models",
    blurb: "Models optimized for Apple Silicon and Apple Neural Engine",
    sections: [
      {
        type: "Agentic",
        models: [
  ...
  return (
    <ModelEncyclopediaProvider>
      <PageFrame>
          ...
          <div className="px-6 py-16 md:py-20">
            ...
            <div className="mt-8 space-y-4">
              ...
              <p className="max-w-2xl text-lg text-muted-foreground">
                A complete catalog of {TOTAL_MODELS} AI models optimized for Apple Silicon and Apple Neural Engine.
              </p>
            </div>
        ...
        <FrameSection>
          <div className="grid grid-cols-1 gap-px bg-border sm:grid-cols-3">
            {[
              ...
              { value: "Apple Silicon", label: "Processor" },
              { value: "macOS · iOS", label: "Devices" },
            ].map((stat) => (
        ...
        <FrameSection>
          <div className="px-6 py-16 md:py-20">
            <span className="font-mono text-xs uppercase tracking-widest text-brand">Why Apple</span>
            <h2 className="mt-3 max-w-2xl text-3xl font-semibold tracking-tight md:text-4xl">
              Apple optimization features
            </h2>
            <p className="mt-4 max-w-2xl text-lg text-muted-foreground">
              These models are optimized for Apple Silicon processors and leverage Metal Performance Shaders 
              and the Apple Neural Engine for enhanced performance on macOS and iOS devices.
            </p>
          </div>
          <div className="grid grid-cols-1 gap-px border-t border-border bg-border md:grid-cols-2">
            <div className="bg-background p-8">
              ...
              <ul className="mt-4 space-y-2 text-sm text-muted-foreground">
                <li className="flex items-start gap-2"><span className="mt-2 h-1 w-1 shrink-0 rounded-full bg-brand" /> Optimized for Apple Silicon architectures (M-series chips)</li>
                <li className="flex items-start gap-2"><span className="mt-2 h-1 w-1 shrink-0 rounded-full bg-brand" /> Enhanced inference speed with Metal Performance Shaders</li>
                <li className="flex items-start gap-2"><span className="mt-2 h-1 w-1 shrink-0 rounded-full bg-brand" /> Power-efficient execution on Apple Neural Engine</li>
                <li className="flex items-start gap-2"><span className="mt-2 h-1 w-1 shrink-0 rounded-full bg-brand" /> Unified memory architecture for fast data access</li>
              </ul>
            </div>
            <div className="bg-background p-8">
              <h3 className="text-lg font-semibold">Supported hardware</h3>
              <ul className="mt-4 space-y-2 text-sm text-muted-foreground">
                <li className="flex items-start gap-2"><span className="mt-2 h-1 w-1 shrink-0 rounded-full bg-brand" /> Apple Silicon M1, M2, M3, and M4 series processors</li>
                <li className="flex items-start gap-2"><span className="mt-2 h-1 w-1 shrink-0 rounded-full bg-brand" /> Apple Neural Engine (ANE)</li>
                <li className="flex items-start gap-2"><span className="mt-2 h-1 w-1 shrink-0 rounded-full bg-brand" /> Apple integrated GPUs</li>
                <li className="flex items-start gap-2"><span className="mt-2 h-1 w-1 shrink-0 rounded-full bg-brand" /> macOS and iOS devices</li>
              </ul>
            </div>
          </div>
        </FrameSection>
          ...
          <div className="px-6 py-16 md:py-20">
            ...
            <ol className="mt-6 max-w-2xl space-y-3 text-sm text-muted-foreground">
              ...
              <li className="flex gap-3">
                ...
                The system automatically applies Apple optimizations when available.
              </li>
              <li className="flex gap-3">
            ...
            <p className="mt-8 text-sm text-muted-foreground">
              For Apple-specific optimization questions, contact our technical support team at{" "}
