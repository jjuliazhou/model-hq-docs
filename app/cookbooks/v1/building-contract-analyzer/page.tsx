  ...
  return (
    <div className="max-w-4xl mx-auto space-y-8 sm:space-y-10 text-[17px] leading-relaxed">
      ...
      <section id="use-case" className="scroll-mt-24 space-y-4">
        ...
        <p className="text-gray-800 dark:text-gray-200 leading-relaxed">Build a <strong>no-code Contract Analyzer agent</strong> that reads contracts and pulls out the same key details every time — automatically.</p>
        ...
        <p className="text-gray-800 dark:text-gray-200 leading-relaxed">In this cookbook we build a <strong>Music License Agreement Analyzer</strong> using the <strong>Visual Builder</strong> in Model HQ — no code needed.</p>
        <p className="text-gray-800 dark:text-gray-200 leading-relaxed">The agent answers simple but useful questions like:</p>
        <ul className="space-y-2.5">
          ...
          <li className="flex items-start gap-3">
            <CheckCircle className="h-5 w-5 mt-0.5 flex-shrink-0 text-blue-600 dark:text-blue-400" />
            <div className="flex-1 text-gray-800 dark:text-gray-200 leading-relaxed">
              <span>Is there an advance payment? If yes, how much?</span>
            </div>
          </li>
        </ul>
        <p className="text-gray-800 dark:text-gray-200 leading-relaxed">Behind the scenes it uses <strong>RAG (Retrieval-Augmented Generation)</strong> with re-ranking to pick the most relevant parts of each contract and give grounded answers.</p>
        <p className="text-gray-800 dark:text-gray-200 leading-relaxed">Once it works on one document, you can run it on many contracts at once with <strong>Batch Mode</strong> and export the results.</p>
        <p className="text-gray-800 dark:text-gray-200 leading-relaxed">The complete no-code set-up for this agent (this example shows 5 nodes — but you can have as few as 2 if you only ask one question):</p>
        <figure className="my-6">
          <img
            src="/cookbooks/v1/01_main.png"
            alt="Contract Analyzer canvas overview"
            className="rounded-lg border border-gray-200 dark:border-gray-800 w-full shadow-sm"
          />
          <figcaption className="text-sm text-gray-500 dark:text-gray-400 text-center mt-2">Contract Analyzer canvas overview</figcaption>
        </figure>
      </section>
      ...
      <section id="who-this-is-for" className="scroll-mt-24 space-y-4">
        ...
        <ul className="space-y-2.5">
          <li className="flex items-start gap-3">
            <CheckCircle className="h-5 w-5 mt-0.5 flex-shrink-0 text-blue-600 dark:text-blue-400" />
            <div className="flex-1 text-gray-800 dark:text-gray-200 leading-relaxed">
              <span><strong>Legal and compliance teams</strong> reviewing contracts (NDAs, licenses, vendor agreements)</span>
            </div>
          </li>
          <li className="flex items-start gap-3">
            <CheckCircle className="h-5 w-5 mt-0.5 flex-shrink-0 text-blue-600 dark:text-blue-400" />
            <div className="flex-1 text-gray-800 dark:text-gray-200 leading-relaxed">
              <span><strong>Business teams</strong> (HR, Operations, Procurement, Finance)</span>
            </div>
          </li>
          <li className="flex items-start gap-3">
            <CheckCircle className="h-5 w-5 mt-0.5 flex-shrink-0 text-blue-600 dark:text-blue-400" />
            <div className="flex-1 text-gray-800 dark:text-gray-200 leading-relaxed">
              <span><strong>Analysts</strong> doing repetitive document review</span>
            </div>
          </li>
          <li className="flex items-start gap-3">
            <CheckCircle className="h-5 w-5 mt-0.5 flex-shrink-0 text-blue-600 dark:text-blue-400" />
            <div className="flex-1 text-gray-800 dark:text-gray-200 leading-relaxed">
              <span><strong>Developers</strong> prototyping document workflows with RAG</span>
            </div>
          </li>
          <li className="flex items-start gap-3">
            <CheckCircle className="h-5 w-5 mt-0.5 flex-shrink-0 text-blue-600 dark:text-blue-400" />
            <div className="flex-1 text-gray-800 dark:text-gray-200 leading-relaxed">
              <span>Anyone who needs to extract the <strong>same information from many similar documents</strong></span>
            </div>
          </li>
        </ul>
      </section>
      ...
      <section id="what-youll-learn" className="scroll-mt-24 space-y-4">
        ...
        <ul className="space-y-2.5">
          <li className="flex items-start gap-3">
            <CheckCircle className="h-5 w-5 mt-0.5 flex-shrink-0 text-blue-600 dark:text-blue-400" />
            <div className="flex-1 text-gray-800 dark:text-gray-200 leading-relaxed">
              <span>How to build a contract analyzer using the <strong>Visual Builder</strong></span>
            </div>
          </li>
          <li className="flex items-start gap-3">
            <CheckCircle className="h-5 w-5 mt-0.5 flex-shrink-0 text-blue-600 dark:text-blue-400" />
            <div className="flex-1 text-gray-800 dark:text-gray-200 leading-relaxed">
              <span>How to connect a document input to multiple <strong>RAG answer steps</strong></span>
            </div>
          </li>
          <li className="flex items-start gap-3">
            <CheckCircle className="h-5 w-5 mt-0.5 flex-shrink-0 text-blue-600 dark:text-blue-400" />
            <div className="flex-1 text-gray-800 dark:text-gray-200 leading-relaxed">
              <span>How re-ranking improves accuracy on long documents</span>
            </div>
          </li>
          <li className="flex items-start gap-3">
            <CheckCircle className="h-5 w-5 mt-0.5 flex-shrink-0 text-blue-600 dark:text-blue-400" />
            <div className="flex-1 text-gray-800 dark:text-gray-200 leading-relaxed">
              <span>How to test the agent on a <strong>single document</strong></span>
            </div>
          </li>
          <li className="flex items-start gap-3">
            <CheckCircle className="h-5 w-5 mt-0.5 flex-shrink-0 text-blue-600 dark:text-blue-400" />
            <div className="flex-1 text-gray-800 dark:text-gray-200 leading-relaxed">
              <span>How to run it on <strong>many documents at once (Batch Mode)</strong></span>
            </div>
          </li>
          <li className="flex items-start gap-3">
            <CheckCircle className="h-5 w-5 mt-0.5 flex-shrink-0 text-blue-600 dark:text-blue-400" />
            <div className="flex-1 text-gray-800 dark:text-gray-200 leading-relaxed">
              <span>How to export results for reporting or automation</span>
            </div>
          </li>
        </ul>
      </section>
      ...
      <section id="ingredients-what-you-need" className="scroll-mt-24 space-y-4">
        ...
        <ul className="list-disc list-outside pl-6 space-y-2 marker:text-gray-400 dark:marker:text-gray-500">
          ...
          <li className="text-gray-800 dark:text-gray-200 leading-relaxed">A local model that supports chat / RAG (we use <strong>Llama 3.2 3B</strong> by default). It downloads automatically the first time you run the agent.</li>
          <li className="text-gray-800 dark:text-gray-200 leading-relaxed">A few sample music license agreements (already included with Model HQ), located at: <code className="px-1.5 py-0.5 rounded bg-gray-100 dark:bg-gray-800 text-[0.875em] font-mono text-gray-800 dark:text-gray-200">C:\Users\&lt;username&gt;\llmware_data\sample_files\AgreementsLarge\</code>. Good ones to try: <em>Cybele Music License Agreement.pdf</em>, <em>Diana Music License Agreement.pdf</em>, <em>Circe License Agreement for Copyrighted Music.pdf</em>.</li>
      ...
      <section id="watch-the-demo" className="scroll-mt-24 space-y-4">
        ...
        <p className="text-gray-800 dark:text-gray-200 leading-relaxed">Want to follow along on video? Here's the full walkthrough on the Model HQ YouTube channel — <em>"Contract Analyzer Agent in Minutes (No-Code + Offline) | Model HQ Demo"</em>. Useful timestamps are called out in each step below.</p>
      ...
      <section id="quick-steps-build-it-in-5-minutes" className="scroll-mt-24 space-y-4">
        <h2 className="text-xl sm:text-2xl lg:text-3xl font-semibold tracking-tight text-gray-900 dark:text-gray-50 border-b border-gray-200 dark:border-gray-800 pb-2">Quick Steps (Build It in 5 Minutes)</h2>
        <p className="text-gray-800 dark:text-gray-200 leading-relaxed">If you just want to copy what's in the screenshot, follow this short version. The detailed walkthrough is right after — read it whenever you want the <em>why</em>.</p>
        <ol className="list-decimal list-outside pl-6 space-y-2 marker:text-gray-500 dark:marker:text-gray-400 marker:font-semibold">
          <li className="text-gray-800 dark:text-gray-200 leading-relaxed pl-1">Open <strong>Agents → Build New → Visual Builder</strong>, click <strong><code className="px-1.5 py-0.5 rounded bg-gray-100 dark:bg-gray-800 text-[0.875em] font-mono text-gray-800 dark:text-gray-200">&gt;</code></strong>.</li>
          <li className="text-gray-800 dark:text-gray-200 leading-relaxed pl-1">Name the agent: <code className="px-1.5 py-0.5 rounded bg-gray-100 dark:bg-gray-800 text-[0.875em] font-mono text-gray-800 dark:text-gray-200">Music_License_Agent</code>.</li>
          <li className="text-gray-800 dark:text-gray-200 leading-relaxed pl-1">Drag an <strong>Input</strong> node onto the canvas → set <strong>Choose input type</strong> to <code className="px-1.5 py-0.5 rounded bg-gray-100 dark:bg-gray-800 text-[0.875em] font-mono text-gray-800 dark:text-gray-200">document</code>.</li>
          <li className="text-gray-800 dark:text-gray-200 leading-relaxed pl-1">Drag a <strong>Node</strong>, set service to <code className="px-1.5 py-0.5 rounded bg-gray-100 dark:bg-gray-800 text-[0.875em] font-mono text-gray-800 dark:text-gray-200">rag_answer</code>, instruction: <code className="px-1.5 py-0.5 rounded bg-gray-100 dark:bg-gray-800 text-[0.875em] font-mono text-gray-800 dark:text-gray-200">Who are the parties to the agreement?</code>. Wire it back to the Input node.</li>
          <li className="text-gray-800 dark:text-gray-200 leading-relaxed pl-1">Repeat step 4 three more times with these questions:
            <ul className="list-[circle] list-outside pl-6 mt-2 space-y-1 marker:text-gray-400 dark:marker:text-gray-500">
              <li className="text-gray-700 dark:text-gray-300 text-[0.95em]"><code className="px-1.5 py-0.5 rounded bg-gray-100 dark:bg-gray-800 text-[0.875em] font-mono text-gray-800 dark:text-gray-200">What is the effective date of the agreement?</code></li>
              <li className="text-gray-700 dark:text-gray-300 text-[0.95em]"><code className="px-1.5 py-0.5 rounded bg-gray-100 dark:bg-gray-800 text-[0.875em] font-mono text-gray-800 dark:text-gray-200">What is the royalty payment to the licensor?</code></li>
              <li className="text-gray-700 dark:text-gray-300 text-[0.95em]"><code className="px-1.5 py-0.5 rounded bg-gray-100 dark:bg-gray-800 text-[0.875em] font-mono text-gray-800 dark:text-gray-200">What is the advance payment to the licensor?</code></li>
            </ul></li>
          <li className="text-gray-800 dark:text-gray-200 leading-relaxed pl-1">(Optional) Add one more node with service <code className="px-1.5 py-0.5 rounded bg-gray-100 dark:bg-gray-800 text-[0.875em] font-mono text-gray-800 dark:text-gray-200">agent_report</code> to get a polished Word/JSON summary.</li>
          <li className="text-gray-800 dark:text-gray-200 leading-relaxed pl-1">Click <strong>Save Agent</strong>, then <strong>Run</strong>, and upload one of the sample PDFs from <code className="px-1.5 py-0.5 rounded bg-gray-100 dark:bg-gray-800 text-[0.875em] font-mono text-gray-800 dark:text-gray-200">AgreementsLarge\</code>.</li>
          <li className="text-gray-800 dark:text-gray-200 leading-relaxed pl-1">Once it works, go back and click <strong>Batch Run</strong> to process several contracts at once.</li>
        </ol>
        <p className="text-gray-800 dark:text-gray-200 leading-relaxed">That's the whole agent. The rest of this cookbook explains each step in plain English.</p>
      </section>
      ...
      <section id="why-model-hq-builds-agents-differently" className="scroll-mt-24 space-y-4">
        ...
        <p className="text-gray-800 dark:text-gray-200 leading-relaxed">Most agent builders run against a big cloud model. Model HQ takes a different approach:</p>
        <ul className="space-y-2.5">
          <li className="flex items-start gap-3">
            <CheckCircle className="h-5 w-5 mt-0.5 flex-shrink-0 text-blue-600 dark:text-blue-400" />
            <div className="flex-1 text-gray-800 dark:text-gray-200 leading-relaxed">
              <span>Each task is <strong>broken into its own small node</strong>.</span>
            </div>
          </li>
          <li className="flex items-start gap-3">
            <CheckCircle className="h-5 w-5 mt-0.5 flex-shrink-0 text-blue-600 dark:text-blue-400" />
            <div className="flex-1 text-gray-800 dark:text-gray-200 leading-relaxed">
              <span><strong>Small, specialized models</strong> are stacked together — one to parse, one to rank, one to answer.</span>
            </div>
          </li>
          <li className="flex items-start gap-3">
            <CheckCircle className="h-5 w-5 mt-0.5 flex-shrink-0 text-blue-600 dark:text-blue-400" />
            <div className="flex-1 text-gray-800 dark:text-gray-200 leading-relaxed">
              <span>The whole workflow runs <strong>on your device</strong>.</span>
            </div>
          </li>
        </ul>
        <p className="text-gray-800 dark:text-gray-200 leading-relaxed">The result: accurate, repeatable answers, without sending your contracts anywhere.</p>
      </section>
      ...
      <section id="step-by-step-walkthrough" className="scroll-mt-24 space-y-4">
        ...
        <p className="text-gray-800 dark:text-gray-200 leading-relaxed"><em>Goal: get to the agent builder.</em> (Min Time Required: ~3:45)</p>
        <ol className="list-decimal list-outside pl-6 space-y-2 marker:text-gray-500 dark:marker:text-gray-400 marker:font-semibold">
          <li className="text-gray-800 dark:text-gray-200 leading-relaxed pl-1">From the <strong>Home Screen</strong>, click <strong>Agents</strong> in the left sidebar.</li>
          <li className="text-gray-800 dark:text-gray-200 leading-relaxed pl-1">In the <em>Agent Menu</em>, choose <strong>Build New</strong>.</li>
          ...
          <li className="text-gray-800 dark:text-gray-200 leading-relaxed pl-1">On the <em>Build New Agent</em> screen, pick <strong>Visual Builder</strong>.</li>
        </ol>
        <p className="text-gray-800 dark:text-gray-200 leading-relaxed">The Visual Builder canvas opens. This is the drag-and-drop space where the agent gets put together.</p>
        <aside className="border-l-4 border-l-emerald-500 bg-emerald-50/60 dark:bg-emerald-950/30 rounded-r-md px-4 py-3 my-4 space-y-2">
        ...
        <p className="text-gray-800 dark:text-gray-200 leading-relaxed">At the top of the canvas, give the agent a name. We'll call ours:</p>
        <div className="my-4">
          <CodeBlock language="text">{`Music_License_Agent`}</CodeBlock>
        </div>
        <p className="text-gray-800 dark:text-gray-200 leading-relaxed">A clear name makes it easy to find later under <strong>Load Existing</strong>, and easy to recognize when you share it with a teammate.</p>
        ...
        <p className="text-gray-800 dark:text-gray-200 leading-relaxed"><em>Goal: tell the agent what kind of input it should expect.</em> (Min Time Required: ~4:19)</p>
        <ol className="list-decimal list-outside pl-6 space-y-2 marker:text-gray-500 dark:marker:text-gray-400 marker:font-semibold">
          <li className="text-gray-800 dark:text-gray-200 leading-relaxed pl-1">On the left sidebar, click and drag the <strong>Input</strong> option onto the canvas.</li>
          <li className="text-gray-800 dark:text-gray-200 leading-relaxed pl-1">Open the node and set:
            <ul className="list-[circle] list-outside pl-6 mt-2 space-y-1 marker:text-gray-400 dark:marker:text-gray-500">
        ...
        <p className="text-gray-800 dark:text-gray-200 leading-relaxed">Now Model HQ knows that, when this agent runs, it should ask the user to upload a document. That document becomes the source for every question we ask next.</p>
        ...
        <p className="text-gray-800 dark:text-gray-200 leading-relaxed"><em>Goal: ask the first question — and tell the agent to answer it from the uploaded document.</em></p>
        <ol className="list-decimal list-outside pl-6 space-y-2 marker:text-gray-500 dark:marker:text-gray-400 marker:font-semibold">
          ...
          <li className="text-gray-800 dark:text-gray-200 leading-relaxed pl-1">In the node's <strong>Choose service</strong> dropdown, pick <code className="px-1.5 py-0.5 rounded bg-gray-100 dark:bg-gray-800 text-[0.875em] font-mono text-gray-800 dark:text-gray-200">rag_answer</code>.</li>
          <li className="text-gray-800 dark:text-gray-200 leading-relaxed pl-1">In the <strong>Instruction</strong> field (this is where you "prompt" the model), type: <code className="px-1.5 py-0.5 rounded bg-gray-100 dark:bg-gray-800 text-[0.875em] font-mono text-gray-800 dark:text-gray-200">Who are the parties to the agreement?</code></li>
          <li className="text-gray-800 dark:text-gray-200 leading-relaxed pl-1"><strong>Wire</strong> the <strong>Input node → this RAG answer node</strong> by dragging a line between their connection dots.</li>
        </ol>
        <p className="text-gray-800 dark:text-gray-200 leading-relaxed">A quick tip on prompting: keep the instruction short, plain, and direct — like you're asking a colleague. <em>"Who are the parties to the agreement?"</em> works far better than a long, formal prompt.</p>
        <aside className="border-l-4 border-l-blue-500 bg-blue-50/60 dark:bg-blue-950/30 rounded-r-md px-4 py-3 my-4 space-y-2">
        ...
        <h3 id="5-add-three-more-rag-answer-nodes" className="text-xl sm:text-2xl font-semibold tracking-tight text-gray-900 dark:text-gray-50 pt-2 scroll-mt-24">5. Add Three More RAG Answer Nodes</h3>
        <p className="text-gray-800 dark:text-gray-200 leading-relaxed">Repeat step 4 for each question. For our Music License Analyzer we add three more <code className="px-1.5 py-0.5 rounded bg-gray-100 dark:bg-gray-800 text-[0.875em] font-mono text-gray-800 dark:text-gray-200">rag_answer</code> nodes — each wired back to the <strong>Input node</strong>:</p>
        <div className="my-5 overflow-x-auto rounded-lg border border-gray-200 dark:border-gray-800">
          <table className="min-w-full text-sm sm:text-base">
            <thead>
              <tr className="bg-gray-50 dark:bg-gray-900 border-b border-gray-200 dark:border-gray-800">
                <th className="px-4 py-3 text-left text-xs sm:text-sm font-semibold uppercase tracking-wide text-gray-700 dark:text-gray-300 whitespace-nowrap">#</th>
                ...
                <th className="px-4 py-3 text-left text-xs sm:text-sm font-semibold uppercase tracking-wide text-gray-700 dark:text-gray-300 whitespace-nowrap">Instruction (the prompt)</th>
              </tr>
            </thead>
        ...
        <p className="text-gray-800 dark:text-gray-200 leading-relaxed">Your canvas should now look like a fan: one Input node feeding four parallel RAG answer nodes.</p>
        <aside className="border-l-4 border-l-emerald-500 bg-emerald-50/60 dark:bg-emerald-950/30 rounded-r-md px-4 py-3 my-4 space-y-2">
        ...
        <h3 id="6-confirm-the-model-and-services" className="text-xl sm:text-2xl font-semibold tracking-tight text-gray-900 dark:text-gray-50 pt-2 scroll-mt-24">6. Confirm the Model and Services</h3>
        <p className="text-gray-800 dark:text-gray-200 leading-relaxed">Click any node to check:</p>
        <ul className="list-disc list-outside pl-6 space-y-2 marker:text-gray-400 dark:marker:text-gray-500">
          ...
          <li className="text-gray-800 dark:text-gray-200 leading-relaxed"><strong>Services</strong> — make sure <code className="px-1.5 py-0.5 rounded bg-gray-100 dark:bg-gray-800 text-[0.875em] font-mono text-gray-800 dark:text-gray-200">rag_answer</code> and <code className="px-1.5 py-0.5 rounded bg-gray-100 dark:bg-gray-800 text-[0.875em] font-mono text-gray-800 dark:text-gray-200">parse_document</code> are turned on in the <strong>Services</strong> catalog (left sidebar → <em>Services</em>).</li>
        </ul>
        <aside className="border-l-4 border-l-blue-500 bg-blue-50/60 dark:bg-blue-950/30 rounded-r-md px-4 py-3 my-4 space-y-2">
        ...
        <h3 id="7-save-and-run-on-one-contract" className="text-xl sm:text-2xl font-semibold tracking-tight text-gray-900 dark:text-gray-50 pt-2 scroll-mt-24">7. Save and Run on One Contract</h3>
        <ol className="list-decimal list-outside pl-6 space-y-2 marker:text-gray-500 dark:marker:text-gray-400 marker:font-semibold">
          <li className="text-gray-800 dark:text-gray-200 leading-relaxed pl-1">Click <strong>Save Agent</strong> (left sidebar).</li>
          ...
          <li className="text-gray-800 dark:text-gray-200 leading-relaxed pl-1">Click <strong><code className="px-1.5 py-0.5 rounded bg-gray-100 dark:bg-gray-800 text-[0.875em] font-mono text-gray-800 dark:text-gray-200">&gt;</code></strong> to start.</li>
        </ol>
        <p className="text-gray-800 dark:text-gray-200 leading-relaxed">Model HQ will parse the document, run each <code className="px-1.5 py-0.5 rounded bg-gray-100 dark:bg-gray-800 text-[0.875em] font-mono text-gray-800 dark:text-gray-200">rag_answer</code> step, and show the results in a <strong>Summary Report Table</strong>.</p>
          ...
          <table className="min-w-full text-sm sm:text-base">
            ...
            <tbody className="divide-y divide-gray-200 dark:divide-gray-800">
              <tr className="hover:bg-gray-50/60 dark:hover:bg-gray-900/40">
                ...
                <td className="px-4 py-3 text-gray-800 dark:text-gray-200 align-top leading-relaxed">The parties are <strong>Cybele</strong> and <strong>Lotus Music Company</strong>.</td>
              </tr>
              <tr className="hover:bg-gray-50/60 dark:hover:bg-gray-900/40">
                ...
                <td className="px-4 py-3 text-gray-800 dark:text-gray-200 align-top leading-relaxed">What is the effective date?</td>
              ...
              <tr className="hover:bg-gray-50/60 dark:hover:bg-gray-900/40">
                ...
                <td className="px-4 py-3 text-gray-800 dark:text-gray-200 align-top leading-relaxed">What is the royalty payment?</td>
                <td className="px-4 py-3 text-gray-800 dark:text-gray-200 align-top leading-relaxed"><em>(royalty schedule extracted from the contract)</em></td>
              </tr>
              <tr className="hover:bg-gray-50/60 dark:hover:bg-gray-900/40">
                ...
                <td className="px-4 py-3 text-gray-800 dark:text-gray-200 align-top leading-relaxed">What is the advance payment?</td>
                <td className="px-4 py-3 text-gray-800 dark:text-gray-200 align-top leading-relaxed"><em>(advance amount extracted from the contract)</em></td>
              </tr>
            </tbody>
          </table>
        </div>
        <p className="text-gray-800 dark:text-gray-200 leading-relaxed">You also get:</p>
        <ul className="list-disc list-outside pl-6 space-y-2 marker:text-gray-400 dark:marker:text-gray-500">
          <li className="text-gray-800 dark:text-gray-200 leading-relaxed">An <strong>Inference History</strong> table — tokens used, first-token latency, and total time per step.</li>
          <li className="text-gray-800 dark:text-gray-200 leading-relaxed">A <strong>Files Created</strong> section — generated reports and artifacts.</li>
        </ul>
        <aside className="border-l-4 border-l-emerald-500 bg-emerald-50/60 dark:bg-emerald-950/30 rounded-r-md px-4 py-3 my-4 space-y-2">
        ...
        <p className="text-gray-800 dark:text-gray-200 leading-relaxed">Want a polished output? Add a final reporting node:</p>
        <ol className="list-decimal list-outside pl-6 space-y-2 marker:text-gray-500 dark:marker:text-gray-400 marker:font-semibold">
          ...
          <li className="text-gray-800 dark:text-gray-200 leading-relaxed pl-1">Set its service to <code className="px-1.5 py-0.5 rounded bg-gray-100 dark:bg-gray-800 text-[0.875em] font-mono text-gray-800 dark:text-gray-200">agent_report</code>.</li>
          <li className="text-gray-800 dark:text-gray-200 leading-relaxed pl-1">Use a clear instruction, e.g. <code className="px-1.5 py-0.5 rounded bg-gray-100 dark:bg-gray-800 text-[0.875em] font-mono text-gray-800 dark:text-gray-200">Music License Agreement — Summary of Key Terms</code>.</li>
          <li className="text-gray-800 dark:text-gray-200 leading-relaxed pl-1">Wire the previous nodes' outputs into it (use a <strong>Transformer</strong> node set to <code className="px-1.5 py-0.5 rounded bg-gray-100 dark:bg-gray-800 text-[0.875em] font-mono text-gray-800 dark:text-gray-200">Agent-State</code> if you need to pass everything along).</li>
        </ol>
        <p className="text-gray-800 dark:text-gray-200 leading-relaxed"><code className="px-1.5 py-0.5 rounded bg-gray-100 dark:bg-gray-800 text-[0.875em] font-mono text-gray-800 dark:text-gray-200">agent_report</code> produces a Word document, a JSON file, and a Markdown summary — automatically pulling in each <code className="px-1.5 py-0.5 rounded bg-gray-100 dark:bg-gray-800 text-[0.875em] font-mono text-gray-800 dark:text-gray-200">rag_answer</code> result.</p>
        <h3 id="9-run-it-in-batch-mode-many-contracts-at-once" className="text-xl sm:text-2xl font-semibold tracking-tight text-gray-900 dark:text-gray-50 pt-2 scroll-mt-24">9. Run It in Batch Mode (Many Contracts at Once)</h3>
        <p className="text-gray-800 dark:text-gray-200 leading-relaxed">Once it works on one contract, scale it up.</p>
        <ol className="list-decimal list-outside pl-6 space-y-2 marker:text-gray-500 dark:marker:text-gray-400 marker:font-semibold">
          <li className="text-gray-800 dark:text-gray-200 leading-relaxed pl-1">Go to <strong>Agents → Load Existing</strong> and pick <strong>Music_License_Agent</strong>.</li>
          <li className="text-gray-800 dark:text-gray-200 leading-relaxed pl-1">Click <strong><code className="px-1.5 py-0.5 rounded bg-gray-100 dark:bg-gray-800 text-[0.875em] font-mono text-gray-800 dark:text-gray-200">&gt;</code></strong>.</li>
          ...
          <li className="text-gray-800 dark:text-gray-200 leading-relaxed pl-1">In <em>Upload Documents for Batch Processing</em>, select several files, e.g.:
            <ul className="list-[circle] list-outside pl-6 mt-2 space-y-1 marker:text-gray-400 dark:marker:text-gray-500">
        ...
        <p className="text-gray-800 dark:text-gray-200 leading-relaxed">Model HQ runs the full agent on each file independently and bundles the results.</p>
        <aside className="border-l-4 border-l-blue-500 bg-blue-50/60 dark:bg-blue-950/30 rounded-r-md px-4 py-3 my-4 space-y-2">
        ...
        <p className="text-gray-800 dark:text-gray-200 leading-relaxed">When the batch is done, you can download:</p>
        <div className="my-5 overflow-x-auto rounded-lg border border-gray-200 dark:border-gray-800">
          <table className="min-w-full text-sm sm:text-base">
            <thead>
              <tr className="bg-gray-50 dark:bg-gray-900 border-b border-gray-200 dark:border-gray-800">
                ...
                <th className="px-4 py-3 text-left text-xs sm:text-sm font-semibold uppercase tracking-wide text-gray-700 dark:text-gray-300 whitespace-nowrap">What it is</th>
              </tr>
            </thead>
            <tbody className="divide-y divide-gray-200 dark:divide-gray-800">
              <tr className="hover:bg-gray-50/60 dark:hover:bg-gray-900/40">
                ...
                <td className="px-4 py-3 text-gray-800 dark:text-gray-200 align-top leading-relaxed">Per-document, per-question answers in JSON. Great for dashboards and APIs.</td>
              </tr>
              <tr className="hover:bg-gray-50/60 dark:hover:bg-gray-900/40">
                ...
                <td className="px-4 py-3 text-gray-800 dark:text-gray-200 align-top leading-relaxed">One Word doc with all answers and a per-document summary.</td>
              </tr>
              <tr className="hover:bg-gray-50/60 dark:hover:bg-gray-900/40">
                <td className="px-4 py-3 text-gray-800 dark:text-gray-200 align-top leading-relaxed">Per-document artifacts</td>
                <td className="px-4 py-3 text-gray-800 dark:text-gray-200 align-top leading-relaxed">Each contract also produces its own report, mermaid chart, and take-aways file.</td>
              </tr>
            </tbody>
          </table>
        </div>
        <p className="text-gray-800 dark:text-gray-200 leading-relaxed">These plug nicely into BI tools, ticketing systems, CLM platforms, or audit trails.</p>
        ...
        <p className="text-gray-800 dark:text-gray-200 leading-relaxed">Once it works, share it without rebuilding:</p>
        <ul className="list-disc list-outside pl-6 space-y-2 marker:text-gray-400 dark:marker:text-gray-500">
          <li className="text-gray-800 dark:text-gray-200 leading-relaxed"><strong>Share by ZIP</strong> — <em>Agents → Load Existing → Music_License_Agent → Share</em>. The ZIP contains only configuration and documents (no executable code), so it's safe to email.</li>
          <li className="text-gray-800 dark:text-gray-200 leading-relaxed"><strong>Upload on another machine</strong> — On your colleague's Model HQ install: <em>Agents → Build New → Upload</em> (or the Upload button next to <em>Load Existing</em>) and pick the ZIP. The agent shows up in their <em>Load Existing</em> list right away.</li>
          <li className="text-gray-800 dark:text-gray-200 leading-relaxed"><strong>Run via the Model HQ API Server</strong> — Expose the agent over a local HTTP endpoint so other apps can use it.</li>
          <li className="text-gray-800 dark:text-gray-200 leading-relaxed"><strong>Add a Demo mode</strong> — Before sharing, set up a demo so colleagues can run the agent end-to-end with one click and immediately see what it does.</li>
        </ul>
      </section>
      ...
      <section id="anatomy-of-the-final-agent" className="scroll-mt-24 space-y-4">
        ...
        <ul className="list-disc list-outside pl-6 space-y-2 marker:text-gray-400 dark:marker:text-gray-500">
          <li className="text-gray-800 dark:text-gray-200 leading-relaxed"><strong>One input</strong> — the contract.</li>
          <li className="text-gray-800 dark:text-gray-200 leading-relaxed"><strong>Several parallel RAG answers</strong> — each one looks at the contract on its own.</li>
          <li className="text-gray-800 dark:text-gray-200 leading-relaxed"><strong>One optional report</strong> — for a polished, shareable summary.</li>
        </ul>
      </section>
          ...
          <table className="min-w-full text-sm sm:text-base">
            ...
            <tbody className="divide-y divide-gray-200 dark:divide-gray-800">
              ...
              <tr className="hover:bg-gray-50/60 dark:hover:bg-gray-900/40">
                ...
                <td className="px-4 py-3 text-gray-800 dark:text-gray-200 align-top leading-relaxed">Easy to find later</td>
              </tr>
              <tr className="hover:bg-gray-50/60 dark:hover:bg-gray-900/40">
                <td className="px-4 py-3 text-gray-800 dark:text-gray-200 align-top leading-relaxed">3</td>
              ...
              <tr className="hover:bg-gray-50/60 dark:hover:bg-gray-900/40">
                ...
                <td className="px-4 py-3 text-gray-800 dark:text-gray-200 align-top leading-relaxed">Each question answered from the contract</td>
              </tr>
              <tr className="hover:bg-gray-50/60 dark:hover:bg-gray-900/40">
              ...
              <tr className="hover:bg-gray-50/60 dark:hover:bg-gray-900/40">
                ...
                <td className="px-4 py-3 text-gray-800 dark:text-gray-200 align-top leading-relaxed">Validate the answers</td>
              </tr>
              <tr className="hover:bg-gray-50/60 dark:hover:bg-gray-900/40">
                ...
                <td className="px-4 py-3 text-gray-800 dark:text-gray-200 align-top leading-relaxed">Polished Word / JSON output</td>
              </tr>
              <tr className="hover:bg-gray-50/60 dark:hover:bg-gray-900/40">
              ...
              <tr className="hover:bg-gray-50/60 dark:hover:bg-gray-900/40">
                ...
                <td className="px-4 py-3 text-gray-800 dark:text-gray-200 align-top leading-relaxed">Send to colleagues or call from an app</td>
              </tr>
            </tbody>
          </table>
        </div>
