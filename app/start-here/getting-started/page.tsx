      ...
      <FrameSection last>
        <div className="mx-auto max-w-5xl space-y-6 px-6 py-12 md:py-16">
          ...
          <div className="space-y-3">
            ...
            <h1 className="text-4xl font-semibold tracking-tight md:text-5xl">Getting Started with Model HQ</h1>
          </div>

          <div>
            <h2 id="laptop-configuration" className="text-xl font-semibold tracking-tight">Laptop Configuration</h2>
            <p className="mt-1 text-sm text-muted-foreground">System requirements for PC and laptop installations</p>
            <img
          ...
          <div className="prose prose-neutral max-w-none dark:prose-invert">
            ...
            <div className='not-prose my-8 aspect-video w-full overflow-hidden border border-border bg-black lg:-mx-16 lg:w-[calc(100%+8rem)]'>
              <iframe
